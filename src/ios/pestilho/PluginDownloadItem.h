...
#import "PluginDownloadItemStatus.h"


@class HWIFileDownloadProgress;


@interface PluginDownloadItem : NSObject
...
@property (nonatomic, assign) PluginDownloadItemStatus status;
...
- (nonnull PluginDownloadItem *)init __attribute__((unavailable("use initWithDownloadIdentifier:remoteURL:")));
+ (nonnull PluginDownloadItem *)new __attribute__((unavailable("use initWithDownloadIdentifier:remoteURL:")));
